...
class Widget:
    def __init__(self, token: str, ref: str, config: Config):
        ...
        widget_loader = PackageLoader('servicewidgetdemo.widgets.media_viewer', 'templates')
    ...
    def render(self):
        ...
        return template.render(token=self.token, workspace_info=workspace_info, media_object=media_object)